...
<li>
    <div class="comment animate-onscroll">
        <div class="comment-author">
            <?php if(!empty($picture)) { print $picture; } else { global $theme_root; print '<img width="70" height="70" src="'.$theme_root . '/img/user.jpg" alt=""/>'; } ?>
            <div class="author-meta">
                <h6><?php print str_replace('xml:lang=""', '', $author); ?></h6>
                <div class="comment-meta">
                    <span><?php print format_date($comment->created, 'custom', 'F d, Y h:i A'); ?></span>
