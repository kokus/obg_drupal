...
/**
 * @file
 * Revija theme's implementation for comments.
 *
 * Available variables:
...
<li class="comment-product">
    <div class="animate-onscroll">
        <div class="cm-product">
            <?php if(!empty($picture)) { print $picture; } else { global $theme_root; print '<img width="50" height="50" src="'.$theme_root . '/img/user-product.jpg" alt=""/>'; } ?>
            <div class="author-meta">
                <h5><?php print str_replace('xml:lang=""', '', $author); ?></h5>
                <div class="comment-meta">
                    <span class="date"><?php print format_date($comment->created, 'custom', 'F d, Y h:i A'); ?></span>
