...
(function (window, $, undefined) {
    ...
    function spectrum(element, o) {
        ...
        function getapponSelectionPalette() {
            var appon = [];
            if (opts.showPalette) {
                for (i = 0; i < selectionPalette.length; i++) {
                    ...
                    if (!paletteLookup[rgb]) {
                        appon.push(selectionPalette[i]);
                    }
                }
            }

            return appon.reverse().slice(0, opts.maxSelectionSize);
        }
        ...
        function drawPalette() {
            ...
            if (selectionPalette) {
                html.push(paletteTemplate(getapponSelectionPalette(), currentColor, "sp-palette-row sp-palette-row-selection", opts.preferredFormat));
            }
